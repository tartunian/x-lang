...
public class TokenSetup {
  private String tokenEnumerationClassName = "TokenType";
  private String tokenStoreClassName = "TokenStore";
  ...
  TokenSetup() {
    try {
      ...
      table = new PrintWriter( new FileOutputStream( "lexer" + sep + "TokenStore.java" ));
      symbols = new PrintWriter( new FileOutputStream( "lexer" + sep + tokenEnumerationClassName + ".java" ));
    } catch( Exception e ) {
  ...
  public void initTokenClasses() {
    ...
    table.println ("*/" );
    table.println ("public class " + tokenStoreClassName + " {" );
    table.println ("   public static java.util.HashMap<" + tokenEnumerationClassName + ",Symbol> tokens = new java.util.HashMap<" + tokenEnumerationClassName + ",Symbol>();" );
    table.println ("   public " + tokenStoreClassName + "() {" );
    ...
    symbols.println ("*/" );
    symbols.println ("public enum " + tokenEnumerationClassName + " {" );
    ...
    while( true ) {
      ...
      String symType = tokenEnumerationClassName + "." + type;
